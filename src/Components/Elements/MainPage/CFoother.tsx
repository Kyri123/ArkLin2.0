...
export default function CFoother( Props : {
	...
	return (
		...
		<footer className="main-footer fixed">
			...
			<strong>Framework by <Link target="_blank" to="https://adminlte.io">AdminLTE.io</Link> | (c)
				...
				<Link className="ps-1" target="_blank" to="https://git.kyrium.space/kyrium"><FontAwesomeIcon
					size={ "lg" } icon={ [ "fab", "gitlab-square" ] }/></Link>
			</strong>
		</footer>
	);
}