	...
	return (
		<div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={ { width: 280 } }>
			<Link to="/home"
				...
				<img alt="logo" src="/img/logo/logo.png" className="pe-none me-2" width={ 40 }/>
			...
			<Nav as="ul" variant="pills" className={ "mb-auto flex-column nav-pills" }>
				<Nav.Item as="li" className="">
					<Link to="/home"
						  className={ `nav-link ${ pathname.endsWith( "/home" ) ? "active" : "" } text-white` }>
				...
				{ Account.HasPermission( EPerm.Super ) &&
					<Nav.Item as="li" className="mt-2">
						<Link to="/users"
							  className={ `nav-link ${ pathname.endsWith( "/users" ) ? "active" : "" } text-white` }>
				...
				{ Account.HasPermission( EPerm.Super ) &&
					<Nav.Item as="li" className="mt-2">
						<Link to="/adminserver"
							  className={ `nav-link ${ pathname.endsWith( "/adminserver" ) ? "active" : "" } text-white` }>
