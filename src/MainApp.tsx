...
const PPanelsettings = React.lazy( () => import("./Pages/MainApp/PPanelsettings") );
const PAdminServer = React.lazy( () => import("./Pages/MainApp/PAdminServer") );
const CTraffics = React.lazy( () => import("./Components/Elements/MainPage/CTraffics") );
const CFoother = React.lazy( () => import("./Components/Elements/MainPage/CFoother") );
const PUsers = React.lazy( () => import("./Pages/MainApp/PUsers") );
const CPanelLog = React.lazy( () => import("./Components/Elements/MainPage/CPanelLog") );
...
export default function MainApp() {
	...
	const [ [ GameServerOnline, GameServerOffline, GameServerTotal ], setGameServerState ] = useState<number[]>( [ 0, 0, 0 ] );
	const [ SystemUsage, setSystemUsage ] = useState<ISystemUsage>( DefaultSystemUsage() );
	...
	useEffect( () => {
		...
		SocketIO.on( "OnServerUpdated", R => setInstances( I => ( {
			...I,
			...R
		} ) ) );
